...
const Trending = () => {
  return (
    <div className="hidden lg:flex flex-col p-2 m-4 mt-4">
      ...
      <div className="w-[500px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3 p-3">
      ...
      <div className="w-[500px] h-[300px] bg-white bg-opacity-10 rounded-3xl mt-3 p-3">
